...
public class RTStructureSetTest {
    ...
    public void read() throws IOException, DicomException {
        ...
        expContourImageItem.setReferencedSOPClassUID(Option.of(UID.CTImageStorage));
        expContourImageItem.setReferencedSOPInstanceUID(Option.of("1.2.392.200036.9116.2.6.1.16.1613471639.1540891527.874748"));
        ...
        structureSetROI0.setROINumber(Option.of(2));
        structureSetROI0.setReferencedFrameOfReferenceUID(Option.of("1.2.392.200036.9116.2.6.1.16.1613471639.1540891246.945610"));
        structureSetROI0.setROIName(Option.of("GTV"));
        structureSetROI0.setROIGenerationAlgorithm(Option.of("SEMIAUTOMATIC"));

        var structureSetROI1 = new StructureSetROIItem();
        structureSetROI1.setROINumber(Option.of(3));
        structureSetROI1.setReferencedFrameOfReferenceUID(Option.of("1.2.392.200036.9116.2.6.1.16.1613471639.1540891246.945610"));
        structureSetROI1.setROIName(Option.of("PTV"));
        structureSetROI1.setROIGenerationAlgorithm(Option.of("SEMIAUTOMATIC"));

        var structureSetROI2 = new StructureSetROIItem();
        structureSetROI2.setROINumber(Option.of(4));
        structureSetROI2.setReferencedFrameOfReferenceUID(Option.of("1.2.392.200036.9116.2.6.1.16.1613471639.1540891246.945610"));
        structureSetROI2.setROIName(Option.of("External"));
        structureSetROI2.setROIGenerationAlgorithm(Option.of("SEMIAUTOMATIC"));

        var structureSetROI3 = new StructureSetROIItem();
        structureSetROI3.setROINumber(Option.of(5));
        structureSetROI3.setReferencedFrameOfReferenceUID(Option.of("1.2.392.200036.9116.2.6.1.16.1613471639.1540891246.945610"));
        structureSetROI3.setROIName(Option.of("TAFEL_SYN23"));
        structureSetROI3.setROIGenerationAlgorithm(Option.of("SEMIAUTOMATIC"));

        var structureSetROI4 = new StructureSetROIItem();
        structureSetROI4.setROINumber(Option.of(1));
        structureSetROI4.setReferencedFrameOfReferenceUID(Option.of("1.2.392.200036.9116.2.6.1.16.1613471639.1540891246.945610"));
        structureSetROI4.setROIName(Option.of("iso"));
        structureSetROI4.setROIGenerationAlgorithm(Option.of("SEMIAUTOMATIC"));
        ...
        expContourImageItem.setReferencedSOPClassUID(Option.of(UID.CTImageStorage));
        expContourImageItem.setReferencedSOPInstanceUID(Option.of("1.2.392.200036.9116.2.6.1.16.1613471639.1540891569.28542"));
        expContourItem.getContourImageSequence().orElse(new ArrayList<>()).add(expContourImageItem);
        expContourItem.setContourGeometricType(Option.of("CLOSED_PLANAR"));
        expContourItem.setNumberOfContourPoints(Option.of(4));
        expContourItem.setContourNumber(Option.of(0));
        expContourItem.setContourData(Option.of(new ArrayList<>()));
...
//                found = true;
        ...
        rtROIObservation0.setObservationNumber(Option.of(1));
        rtROIObservation0.setReferencedROINumber(Option.of(2));
        rtROIObservation0.setROIObservationLabel(Option.of("GTV"));
        rtROIObservation0.setRTROIInterpretedType(Option.of("GTV"));
//        rtROIObservation0.setROIInterpreter(Option.of(""));
//        rtROIObservation0.setMaterialID(Option.of(""));

        var rtROIObservation1 = new RTROIObservationsItem();
        rtROIObservation1.setObservationNumber(Option.of(2));
        rtROIObservation1.setReferencedROINumber(Option.of(3));
        rtROIObservation1.setROIObservationLabel(Option.of("PTV"));
        rtROIObservation1.setRTROIInterpretedType(Option.of("PTV"));
//        rtROIObservation1.setROIInterpreter(Option.of(""));
//        rtROIObservation1.setMaterialID(Option.of(""));

        var rtROIObservation2 = new RTROIObservationsItem();
        rtROIObservation2.setObservationNumber(Option.of(3));
        rtROIObservation2.setReferencedROINumber(Option.of(4));
        rtROIObservation2.setROIObservationLabel(Option.of("External"));
        rtROIObservation2.setRTROIInterpretedType(Option.of("EXTERNAL"));
//        rtROIObservation2.setROIInterpreter(Option.of(""));
//        rtROIObservation2.setMaterialID(Option.of(""));

        var rtROIObservation3 = new RTROIObservationsItem();
        rtROIObservation3.setObservationNumber(Option.of(4));
        rtROIObservation3.setReferencedROINumber(Option.of(5));
        rtROIObservation3.setROIObservationLabel(Option.of("TAFEL_SYN23"));
        rtROIObservation3.setRTROIInterpretedType(Option.of("SUPPORT"));
//        rtROIObservation3.setROIInterpreter(Option.of(""));
        var expROIPhysicalProperties0 = new ROIPhysicalPropertiesItem();
        expROIPhysicalProperties0.setROIPhysicalProperty(Option.of("REL_MASS_DENSITY"));
        expROIPhysicalProperties0.setROIPhysicalPropertyValue(Option.of(0.25));
        var expROIPhysicalProperties1 = new ROIPhysicalPropertiesItem();
        expROIPhysicalProperties1.setROIPhysicalProperty(Option.of("REL_ELEC_DENSITY"));
        expROIPhysicalProperties1.setROIPhysicalPropertyValue(Option.of(0.250037));
        var expROIPhysicalProperties2 = new ROIPhysicalPropertiesItem();
        expROIPhysicalProperties2.setROIPhysicalProperty(Option.of("EFFECTIVE_Z"));
        expROIPhysicalProperties2.setROIPhysicalPropertyValue(Option.of(6.600049));
        var expROIPhysicalProperties3 = new ROIPhysicalPropertiesItem();
        expROIPhysicalProperties3.setROIPhysicalProperty(Option.of("EFF_Z_PER_A"));
        expROIPhysicalProperties3.setROIPhysicalPropertyValue(Option.of(0.5550822));
        var expROIPhysicalProperties4 = new ROIPhysicalPropertiesItem();
        expROIPhysicalProperties4.setROIPhysicalProperty(Option.of("ELEM_FRACTION"));
        expROIPhysicalProperties4.setROIPhysicalPropertyValue(Option.of(0.0));
        var roiElementalComposition0 = new ROIElementalCompositionItem();
        roiElementalComposition0.setRoiElementalCompositionAtomicNumber(Option.of(1));
        roiElementalComposition0.setRoiElementalCompositionAtomicMassFraction(Option.of(0.11189399659633636));
        var roiElementalComposition1 = new ROIElementalCompositionItem();
        roiElementalComposition1.setRoiElementalCompositionAtomicNumber(Option.of(8));
        roiElementalComposition1.setRoiElementalCompositionAtomicMassFraction(Option.of(0.8881059885025024));
        expROIPhysicalProperties4.setROIElementalCompositionSequence(Option.of(new ArrayList<>()));
        ...
        rtROIObservation3.setROIPhysicalPropertiesSequence(Option.of(new ArrayList<>()));
        ...
        rtROIObservation3.setMaterialID(Option.of("TAFEL_SYN23"));

        var rtROIObservation4 = new RTROIObservationsItem();
        rtROIObservation4.setObservationNumber(Option.of(5));
        rtROIObservation4.setReferencedROINumber(Option.of(1));
        rtROIObservation4.setROIObservationLabel(Option.of("iso"));
        rtROIObservation4.setRTROIInterpretedType(Option.of("ISOCENTER"));
//        rtROIObservation4.setROIInterpreter(Option.of(""));
//        rtROIObservation4.setMaterialID(Option.of(""));
